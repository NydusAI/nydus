...
- <https://docs.openclaw.ai/reference/AGENTS.default>: Default AGENTS.md
- <https://docs.openclaw.ai/reference/templates/AGENTS>: AGENTS.md template
- <https://docs.openclaw.ai/reference/templates/SOUL>: SOUL.md template
- <https://docs.openclaw.ai/reference/templates/USER>: USER.md template
- <https://docs.openclaw.ai/reference/templates/IDENTITY>: IDENTITY template
- <https://docs.openclaw.ai/reference/templates/TOOLS>: TOOLS.md template
- <https://docs.openclaw.ai/reference/templates/BOOT>: BOOT.md template
- <https://docs.openclaw.ai/reference/templates/BOOTSTRAP>: BOOTSTRAP.md template
- <https://docs.openclaw.ai/reference/templates/HEARTBEAT>: HEARTBEAT.md template
- <https://docs.openclaw.ai/tools>: Tools and plugins
